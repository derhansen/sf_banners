...
#
# Table structure for table 'tx_sfbanners_domain_model_bannerdemand'
#
CREATE TABLE tx_sfbanners_domain_model_bannerdemand (

	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,

	categories tinytext NOT NULL,
	starting_point tinytext NOT NULL,
	display_mode varchar(255) DEFAULT '' NOT NULL,
	current_page_uid int(11) DEFAULT '0' NOT NULL,
