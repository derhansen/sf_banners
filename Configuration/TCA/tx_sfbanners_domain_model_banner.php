...
return array(
	'ctrl' => array(
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('sf_banners') . 'Resources/Public/Icons/tx_sfbanners_domain_model_banner.gif'
	),
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, description, type, category, image, margin_top, margin_right, margin_bottom, margin_left, alttext, link, html, flash, flash_width, flash_height, flash_wmode, flash_allow_script_access, impressions_max, clicks_max, impressions, clicks, includepages, include_recursive, excludepages, recursive',
	),
	'columns' => array(
		...
		'includepages' => Array (
			'exclude' => 0,
			'label' => 'LLL:EXT:sf_banners/Resources/Private/Language/locallang_db.xlf:tx_sfbanners_domain_model_banner.includepages',
			'config' => Array (
				'type' => 'group',
				'internal_type' => 'db',
				'allowed' => 'pages',
				...
				'minitems' => 0,
				'maxitems' => 100,
				'MM' => 'tx_sfbanners_domain_model_banner_includepages_mm',
				'foreign_table' => 'pages',
			)
		),
		'include_recursive' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:sf_banners/Resources/Private/Language/locallang_db.xlf:tx_sfbanners_domain_model_banner.include_recursive',
			'config' => array(
				'type' => 'check',
			),
		),
	...
	'types' => array(
		'0' => array(
			...
			--div--;LLL:EXT:sf_banners/Resources/Private/Language/locallang_db.xlf:tx_sfbanners_domain_model_banner.tabs.display, category, includepages, include_recursive, excludepages, recursive,
