...
/**
 * Test case for class Tx_Sf_banners_Controller_BannerController.
 *
 * @version $Id$
 ...
 */
class Tx_Sf_banners_Controller_BannerControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
