...
/**
 * Test case for class Tx_Sf_banners_Controller_CategoryController.
 *
 * @version $Id$
 ...
 */
class Tx_Sf_banners_Controller_CategoryControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
